...
- **D1, D3 단위과제 국비 100% 기술 규칙**: D1, D3 단위과제와 그 하위 프로그램들의 예산 기획 및 분할 시, 프론트엔드(`App.jsx`)와 백엔드 보정 스크립트에서 시비 매칭 비율을 0%로 강제 통제하며 국비 100%로 롤업 및 연산되도록 예외 기술 로직을 설계 및 반영합니다.

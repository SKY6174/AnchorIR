...
def sign_pdf_endpoint(file: UploadFile = File(...)):
    ...
    try:
        ...
        return StreamingResponse(
            ...
            headers={
                "Content-Disposition": "attachment; filename=signed_report.pdf"
            }
        )

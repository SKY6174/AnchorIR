...
const d2Programs = [
  ...
  { id: "D2-S1T5-1", title: "사회적약자 의료케어 모니럼 프로그램 운영", budget: 21000000, category: "교육∙연구 프로그램 개발∙운영비", assignee: "박인숙" },
...
const d3Programs = [
  ...
  { id: "D3-S1T1-2", title: "국중박 벤치마킹", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S1T1-3", title: "(이월사업)(문화/도시재생 체험 프로그램)북구 이화정 벤치마킹", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S1T1-4", title: "K-컬처 글로벌 교류 프로젝트: 대만 충유대 교류 프로그램", budget: 28400000, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S1T1-5", title: "(이월사업)(문화/도시재생 체험 프로그램)울리단길 런케이션", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S1T2-1", title: "콘텐츠 크리에이터 연계 프로젝트(실무 프로젝트)", budget: 30000000, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S1T2-2", title: "(이월사업)(콘텐츠 크리에이터 양성프로그램 심화과정)세계유산 도시 울산, 첫 페이지를 열다", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S1T3-1", title: "도시재생 체험 프로젝트", budget: 40000000, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S1T3-2", title: "대학내 커뮤니티 공간 구축(북카페조성)", budget: 200000000, category: "실험∙실습장비 및 기자재 구입∙운영비", assignee: "오영경" },
  { id: "D3-S1T3-3", title: "(이월사업)지역 커뮤니티 공간 기자재 구입", budget: 0, category: "실험∙실습장비 및 기자재 구입∙운영비", assignee: "오영경" },
  ...
  { id: "D3-S2T6-2", title: "①힙합라운지-청년문화체험", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T6-3", title: "②대학이 여는 도시재생-그래피티 운영", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T6-4", title: "③지산학 페스티벌-그래피티 부스 운영", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T6-5", title: "④문화-도시 재생 네트워킹 라운드 테이블", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T6-6", title: "⑤3개대학 연합 문화관광 서포터즈 발대식", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T7-1", title: "지역사회 연계 및 교류 홍보", budget: 10000000, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T7-2", title: "지산학 실내 부스 센터별 지원금", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T7-3", title: "(이월사업)(성과활용확산)세계인의 날 연계 전통문화체험 부스 운영", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },
  { id: "D3-S2T7-4", title: "(이월사업)(성과활용확산)도시재생 거버넌스 운영", budget: 0, category: "교육∙연구 프로그램 개발∙운영비", assignee: "오영경" },

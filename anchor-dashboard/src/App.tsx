...
import type { AssetReservation, Html2PdfFactory, LegacyAppRecord, LegacyYearRecord, ProgramVersionRequest, RiseMemberInsert } from "./app/app-types";
import { INITIAL_AGREEMENTS, INITIAL_MEMBERS } from "./app/app-seed-data";
import { formatDataToMultiYear, formatToMillionWon, getErrorMessage, getRealUnitId, mergeProjectsWithInitial, migrateProgramIds, recalculateCarryOver } from "./app/app-data-utils";
import { normalizeProjectsMultiYearData } from "./app/app-project-normalization";
import { useDashboardDataLoad } from "./app/hooks/use-dashboard-data-load";
...
import { ManagementScreen } from "./features/management/screens/management-screen";
import { insertRiseMember, upsertRiseMember, upsertRiseMembers } from "./features/management/services/member-service";
      ...
      <main className="main-content" style={{ opacity: isScrollRestored ? 1 : 0, transition: "opacity 0.22s ease-in-out" }}>
        ...
        {activeTab === "projects" && (
          <ProjectsScreen
            ...
            pdcaViewMode={pdcaViewMode}
            setPdcaViewMode={setPdcaViewMode}
            currentRole={currentRole}
            currentUser={currentUser}
            supabase={supabase}
            ...
            handleUpdateProgramDetails={handleUpdateProgramDetails}
            handleAddProgram={handleAddProgram}
          />
        )}

        <ManagementScreen
          isActive={Boolean(activeTab === "management" && currentRole)}
          currentRole={currentRole}
          currentUser={currentUser}
          darkMode={darkMode}
          selectedYear={selectedYear}
          ...
          editResFormData={editResFormData}
          setEditResFormData={setEditResFormData}
          menuVisibility={menuVisibility}
          isSongDirector={Boolean(isSongDirector)}
          handleDownloadMemberTemplate={handleDownloadMemberTemplate}
          handleMemberExcelImport={handleMemberExcelImport}
          handleExportMembersExcel={handleExportMembersExcel}
          handleUploadExcel={handleUploadExcel}
          handleDownloadExcel={handleDownloadExcel}
          handleOpenAddProgram={handleOpenAddProgram}
          ...
          handleOpenEditTime={handleOpenEditTime}
          handleSaveEditedTime={handleSaveEditedTime}
          handleSaveMenuVisibility={handleSaveMenuVisibility}
          renderBudgetCategoriesDiff={renderBudgetCategoriesDiff}
          renderTimelineDiff={renderTimelineDiff}
        />
        ...
        {activeTab === "agreements" && (
          <AgreementsScreen
            subTab={agreementsSubTab}
            onChangeSubTab={setAgreementsSubTab}
            darkMode={darkMode}
            projects={displayProjects}

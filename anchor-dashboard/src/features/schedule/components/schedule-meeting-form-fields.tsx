...
interface ScheduleMeetingFormFieldsProps {
  ...
  setAgendaResultPairs: Dispatch<SetStateAction<AgendaResultPair[]>>;
...
export function ScheduleMeetingFormFields({
  agendaResultPairs,
  aiDebateLogs,
  aiFileName,
  aiPlanApplied,
  ...
  triggerAiAutoFill
}: ScheduleMeetingFormFieldsProps) {
  return (
                <>

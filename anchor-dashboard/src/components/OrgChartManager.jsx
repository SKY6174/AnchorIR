...
import { Network, ChevronRight, ChevronDown, Award, Phone, MapPin, Shield, Layers, BookOpen, Star } from "lucide-react";
    ...
    departments: [
      {
        name: "산학지원실",
        subTeams: [
          { name: "산학기획팀", tel: "052-230-0200", loc: "산학협력관 3층", task: "산학 연구 과제 기획 및 가족회사 네트워킹 운영" },
          { name: "산학지원팀", tel: "052-230-0201", loc: "산학협력관 3층", task: "산학 연구비 집행 정산 및 지식재산권 관리" },
          { name: "현장실습지원센터", tel: "052-230-0202", loc: "산학협력관 2층", task: "재학생 하계/동계 기업 인턴십 및 현장 실습 매칭", rise: "A1 (주문식 현장실습 연계)" },
          { name: "창업창직교육센터", tel: "052-230-0203", loc: "산학협력관 2층", task: "창업보육센터 지원 및 벤처 스타트업 교육", rise: "A2 (U-RISE 스타트업 연계)" },
          { name: "울산광역시탄소중립지원센터", tel: "052-230-0204", loc: "연구관 4층", task: "울산형 탄소중립 실행계획 및 정책 제안 수립", rise: "1차년도 ESG/탄소중립 문화체험 연계" },
          { name: "산업안전교육센터", tel: "052-230-0205", loc: "안전교육원", task: "산업체 근로자 보건안전 훈련 및 모의 시뮬레이션", rise: "재난안전 공동사업(MOU) 연계" },
          { name: "종합환경분석센터", tel: "052-230-0206", loc: "연구관 1층", task: "지역 토양 및 수질 검사 대행 업무" },
          { name: "영상콘텐츠제작센터", tel: "052-230-0207", loc: "창의관 2층", task: "RISE 사업 홍보 영상 및 온라인 교육 콘텐츠 제작", rise: "홍보영상 Shorts 및 성과 스케치 연계" },
          { name: "스포츠재활운동센터", tel: "052-230-0208", loc: "체육관 1층", task: "스포츠재활 트레이닝 코칭 및 시민 재활 개방형 프로그램" },
          { name: "일학습병행공동훈련센터", tel: "052-230-0209", loc: "산학협력관 1층", task: "고용노동부 주관 일학습병행 훈련과정 운영" },
          { name: "공동훈련센터(지산맞)", tel: "052-230-0210", loc: "산학협력관 1층", task: "지역·산업 맞춤형 인력양성 훈련" }
        ]
      }
    ]
  },
            ...
            <div className="glass-card" style={{ padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1.25rem", border: "1px solid rgba(59, 130, 246, 0.2)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem", fontSize: "0.85rem" }}>
                ...
                <div style={{ display: "flex", alignItems: "start", gap: "0.5rem" }}>
                  <Layers size={16} className="text-secondary" style={{ marginTop: "0.1rem" }} />
                  <div>

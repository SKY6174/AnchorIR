    ...
    departments: [
      {
        ...
        subTeams: [
          ...
          { name: "교수학습지원센터", tel: "052-230-0117", loc: "대학본부 3층", task: "교수법 및 학습법 개발 지도, 원격 교육 지원", rise: "RISE 교수법 혁신 모델 연구 연계" },
      ...
      },
      {
        ...
        subTeams: [
          ...
          { name: "대외협력실", tel: "052-230-0121", loc: "대학본부 1층", task: "언론 홍보, SNS 채널 관리 및 대외 기관 네트워킹", rise: "RISE 사업 대외 브랜딩 연계" }
        ]
      },
      {
        name: "입학처",
      ...
      },
      {
        name: "총무처",
        subTeams: [
          { name: "총무팀", tel: "052-230-0150", loc: "대학본부 1층", task: "자산 관리, 보안 및 의전 행정 총괄", rise: "RISE 사업단 행정 자산 및 물품 관리 협업" },
          { name: "시설안전관리팀", tel: "052-230-0152", loc: "공학관 B동 1층", task: "교내 시설물 소방 안전 진단 및 환경 개선용역 관리", rise: "구매용역 환경개선 연계" },
          { name: "재무회계팀", tel: "052-230-0151", loc: "대학본부 1층", task: "대학 예결산 관리 및 자금 집행 검증", rise: "RISE 사업비 대학 자금 매칭 및 예산 감사" }
        ]
      }
    ]
  },
    ...
    departments: [
      ...
      },
      {
        ...
        subTeams: [
          ...
          { name: "기업인재교육본부", tel: "052-230-0209", loc: "산학협력관 1층", task: "일학습병행 공동훈련센터 및 지역·산업 맞춤형 전문 인력양성 훈련 운영" },
          { name: "울산형유아교육·보육혁신지원사업단", tel: "052-230-0215", loc: "인문관 2층", task: "유아 보육 모델 혁신 연구 및 교사 연수 지원", rise: "B2 (늘봄/보육 거점 협력)" },
          { name: "간호학부실습교육지원사업단", tel: "052-230-0214", loc: "간호관 3층", task: "간호 시뮬레이션 및 현장 임상 가상 실습 교육 지원", rise: "자연과학 보건 인재 양성" },
          { name: "울산동구 근골격 건강지원센터", tel: "052-230-0216", loc: "체육관 1층", task: "동구 지역 주민 근골격 노화 예방 및 헬스 케어 교실 운영", rise: "지역 공헌 협력 연계" }
        ]
      }
    ]
  },
    ...
    departments: [
      ...
      },
      {
        ...
        subTeams: [
          ...
          { name: "지역혁신중심대학지원체계(RISE) 사업단", tel: "052-230-0255", loc: "산학협력관 4층", task: "지자체-대학-산업 연계 라이즈 예산 기획 및 성과 지표 고도화 총괄", rise: "RISE 사업 총괄 연계" },
          { name: "신산업분야특화선도 전문대학지원사업단", tel: "052-230-0256", loc: "연구관 3층", task: "2차전지 전문 트랙 기반 재직자 직무 교육 및 장비 확보 지원" },
    ...
    departments: [
      {
        ...
        subTeams: [
          ...
          { name: "game영상학과", tel: "052-230-1150", loc: "창의관 4층", task: "실시간 게임 그래픽, 3D 애니메이션 및 엔진 코딩" },

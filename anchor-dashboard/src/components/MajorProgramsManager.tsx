...
import { OrderlyCourseResultTab } from "../features/major-programs/components/orderly-course-result-tab";
import { majorProgramsData, ORDERLY_COURSES, PM_PROFESSORS } from "../features/major-programs/data/major-program-data";
import { parseSeminarMarkdown } from "../features/major-programs/utils/seminar-markdown-parser";
import type {
  CourseStatus,
  CourseStatusKey,
  MajorProgram,
  ...
  const handleFileUpload = (file: File | null | undefined) => {
    ...
    if (isPdf) {
      ...
      reader.onload = (e) => {
        ...
        const dynamicParsedData = parseSeminarMarkdown(textContent, fileName);
...
{orderlyTab === "result" && (
                      <OrderlyCourseResultTab
                        ...
                        setStudentMasterList={setStudentMasterList}
                        selectedResultDeptFilter={selectedResultDeptFilter}
                        setSelectedResultDeptFilter={setSelectedResultDeptFilter}
                        newStudentId={newStudentId}
                        setNewStudentId={setNewStudentId}
                        newStudentName={newStudentName}
                        setNewStudentName={setNewStudentName}
                        newStudentDept={newStudentDept}
                        setNewStudentDept={setNewStudentDept}
                        downloadResultSample={downloadResultSample}

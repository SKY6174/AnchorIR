...
export default function CenterOrgChartManager() {
  ...
  const nodeDetails = {
    president: {
      title: "울산과학대학교 총장",
      desc: "RISE 사업 총괄 책임자 및 최고 승인 권한자",
      tasks: ["RISE 계획 및 핵심 성과 총괄 승인", "지자체-대학 거버넌스 협력체계 구축 총괄", "대학 예산 배분 및 최종 감사"]
    },
    director: {
      title: "앵커사업단장 (송경영 단장)",
      desc: "울산과학대학교 RISE 사업 실무 집행 최고 책임자",
    ...
    <div className="org-chart-container" style={{ display: "flex", flexDirection: "column", gap: "1.5rem", width: "100%", userSelect: "none" }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", gap: "2rem" }}>
          ...
          {/* 4층: 5개 센터들 (가로 그리드 정렬) */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "1rem", width: "100%", alignItems: "start" }}>

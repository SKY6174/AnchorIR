...
import { ProcurementMilestonePopover } from "../features/procurement/components/procurement-milestone-popover";
...
export default function ProcurementManager({
  ...
  return (
    <div className="procurement-manager-container" style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      {activePopover && (
        <ProcurementMilestonePopover
          activePopover={activePopover}
          equipData={equipData}
          formData={formData}
          getMilestoneArray={getMilestoneArray}
          handleMilestoneMultiToggle={handleMilestoneMultiToggle}

...
import { Plus, Trash2, Edit2, Calendar, Search, Check, TrendingUp, Upload, Download } from "lucide-react";
import { SPACES, SPACE_ROOMS, USAGE_TYPES } from "../features/assets/asset-constants";
import { AssetReservationModal } from "../features/assets/components/asset-reservation-modal";
import { AssetReservationTimeModal } from "../features/assets/components/asset-reservation-time-modal";
import { AssetSubtabNavigation } from "../features/assets/components/asset-subtab-navigation";
import { AssetEquipmentModal } from "../features/assets/components/asset-equipment-modal";
import { AssetUtilizationModal } from "../features/assets/components/asset-utilization-modal";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem", color: "var(--text-primary)" }}>
      ...
      {isEquipModalOpen && (
        <AssetEquipmentModal
          ...
          completedProcuredItems={completedProcuredItems}
          editingEquipId={editingEquipId}
          equipFormData={equipFormData}
          handleSaveEquipment={handleSaveEquipment}
          loading={loading}
          setEquipFormData={setEquipFormData}
      ...
      {isUtilModalOpen && selectedUtilEquip && (
        <AssetUtilizationModal
          ...
          handleSaveUtilization={handleSaveUtilization}
          selectedUtilEquip={selectedUtilEquip}
          setIsUtilModalOpen={setIsUtilModalOpen}
          setUtilFormData={setUtilFormData}
          utilFormData={utilFormData}

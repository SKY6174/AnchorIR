...
const STRATEGY_TASK_MAPPING = {
  ...
  "D2": {
    ...
    tasks: [
      { strat: "S1", id: "1", title: "지산학 보건 거버넌스 구축 및 협력 모델 고도화" },
      { strat: "S1", id: "2", title: "보건의료 인재 교육 및 조달 기자재 인프라 확충" },
      { strat: "S1", id: "3", title: "사회적 약자 밀착 케어 역량 강화 및 주민 참여 프로그램 운영" },
      { strat: "S1", id: "4", title: "AI/빅데이터 기반 보건의료 교육 및 지역 연계 모델 구축" },
      { strat: "S1", id: "5", title: "주민 건강 복지 강화를 위한 사회적 약자 의료케어 모니터링" },
      { strat: "S1", id: "6", title: "취약 계층 대상 사회적약자 보건복지서비스 역량강화 지원" },
      { strat: "S2", id: "7", title: "보건복지 지산학 협력 전문인력 양성 및 AI 혁신 공익 프로젝트" },
      { strat: "S2", id: "8", title: "보건의료 전공 인재 역량 강화 및 학술 활동 지원" },
      { strat: "S2", id: "9", title: "보건의료 서비스 인재 지산학 연계 취업역량 강화 지원" },
      { strat: "S2", id: "10", title: "지속가능한 신규학과 개설 지원 및 보건 인프라 교육환경 개선" }
    ],
    programs: [
      { strat: "S1", id: "D2-S1T1-1", title: "지산학 보건 거버넌스 구축 및 운영" },
      { strat: "S1", id: "D2-S1T2-1", title: "맞춤형 보건복지 서비스 역량강화를 위한 기자재 & 장비" },
      { strat: "S1", id: "D2-S1T2-2", title: "신규학과 (반려동물/K-뷰티/외국인요양보호사) 기자재 & 장비" },
      { strat: "S1", id: "D2-S1T3-1", title: "사회적약자 의료케어 역량강화교육 프로그램 운영(주민참여형)" },
      { strat: "S1", id: "D2-S1T3-2", title: "교내 시설 활용 주민참여 프로그램 운영" },
      { strat: "S1", id: "D2-S1T4-1", title: "AI 보건의료 빅데이터 교육 프로그램 운영" },
      { strat: "S1", id: "D2-S1T4-2", title: "지역의료기관 연계 사업 운영" },
      { strat: "S1", id: "D2-S1T5-1", title: "사회적약자 의료케어 모니터링 프로그램 운영" },
      { strat: "S1", id: "D2-S1T6-1", title: "사회적약자 보건복지서비스 역량강화 프로그램 운영" },
      { strat: "S2", id: "D2-S2T7-1", title: "공공보건 의료데이터와 AI혁신 챌린지 운영" },
      { strat: "S2", id: "D2-S2T7-2", title: "보건복지서비스 역량강화 전문인력양성 혁신 프로그램 운영" },
      { strat: "S2", id: "D2-S2T8-1", title: "지역정주형 보건의료 인재 역량강화 프로그램 운영" },
      { strat: "S2", id: "D2-S2T9-1", title: "지역 연계형 보건복지 취업역량 강화 프로그램 운영" },
      { strat: "S2", id: "D2-S2T10-1", title: "신규학과 개설&지원을 위한 통합형 보건인재 양성 교육환경 개선 + 외국인요양보호사" }
    ]
  },
  "D3": {
    strategies: [

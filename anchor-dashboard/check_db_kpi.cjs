...
async function main() {
  ...
  if (targetProg) {
    ...
    console.log('kpi_types:', JSON.stringify(targetProg.kpi_types));
    console.log('kpi_links:', JSON.stringify(targetProg.kpi_links));
    console.log('kpi_targets:', JSON.stringify(targetProg.kpi_targets));
    console.log('kpi_actuals:', JSON.stringify(targetProg.kpi_actuals));
  } else {

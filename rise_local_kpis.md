...
| :---: | :--- | :---: | :---: | :--- |
| **1** | 지역 맞춤형 교과과정 혁신지수 | **A-1** | 107.6% | 개편건수(40%) + 이수학생(30%) + 지역취업(20%) + 외지취업(10%) |
| **2** | 현장실습 참여성과지수 | **A-1** | 105.6% | 12주이상 실습(30%) + 8주이상 실습(20%) 등 기간별 가중합 |
| **3** | 창업교육 운영성과지수 | **A-2** | 107.7% | 창업과정 운영건수(50%) + 창업과정 이수학생수(50%) |
| **4** | 창업 활성화지수 | **A-2** | 166.7% | 창업지원 프로그램수(50%) + 창업기업수(40%) + 매출액(10%) |
| **5** | 산학기술 이전 및 기술사업화 성과지수 | **B-1** | 50.0% | 기술이전건수(25%) + 기술료수익(25%) + 특허출원(30%) + 논문수(10%) 등 |
| **6** | 기업애로 해결 지원 지수 | **B-1** | 103.3% | 기업애로 기술지원 건수(70%) + 기업컨설팅 지원 건수(30%) |
| **7** | 평생·직업교육 활성화지수 | **C-1** | 108.2% | 평생교육 프로그램 이수자(70%) + 성인학습자 등록생 수(30%) |
| **8** | 평생·직업교육 프로그램 품질향상지수 | **C-1** | 111.7% | 프로그램 개발건수(30%) + 유지취업률(30%) + 취·창업률(40%) |
| **9** | 지역 현안 해결 지수 | **D-1** | 113.1% | 현안 프로젝트 수(50%) + 협의체 운영 건수(30%) + 참여 기업 수(20%) |
| **10** | 지역사회 공헌활동 활성화지수 | **D-1** | 126.3% | 특화 사회공헌 참여자 수(70%) + 행사 봉사활동 참여자 수(30%) |
| **11** | 재난 및 산업안전 확산지수 | **B-4** | 100.0% | 안전기술지원 건수(40%) + 시스템개발 건수(30%) + 확산활동 건수(30%) |
| **12** | 재난 및 산업안전 교육성과 종합지수 | **B-4** | 111.3% | 교육개편(20%) + 이수자수(40%) + 자격취득(20%) + 적용기업수(20%) |
| **13** | AI·DX 관련 교육프로그램 운영성과지수 | **B-2** | 113.0% | AI·DX 교육프로그램 개발 건수(30%) + 교육 이수자 수(70%) |
| **14** | AI·DX 역량강화 달성지수 | **B-2** | 100.0% | 교직원/재직자 공동교육 참여 건수 (100%) |
| **15** | ESG 전문인력 양성·경영실현 지수 | **B-3** | 103.5% | ESG 양성 교육 이수자 수(70%) + ESG 경영개선 지원 건수(30%) |
| **16** | 탄소중립 지원 실천 지수 | **B-3** | 123.3% | 탄소중립 프로그램 운영 건수(70%) + 탄소배출 경영개선 지원 건수(30%) |
| **17** | 지역 의료인력 양성 및 정주 지원지수 | **D-2** | 해당없음 | 춘해보건대 주관 (본교 성과 간접 반영) |
| **18** | 사회적 약자 의료케어 종합 달성지수 | **D-2** | 122.2% | 의료 프로그램 수(30%) + 이수학생 수(30%) + 수혜 지역민 수(40%) |
| **19** | 늘봄/방과후 교사 양성 프로그램 운영성과 지수 | **C-2** | 170.0% | 늘봄교사 양성 프로그램 수(50%) + 양성 과정 이수자 수(50%) |
| **20** | 돌봄 및 체험프로그램 운영 활성화지수 | **C-2** | 168.75% | 돌봄/체험 프로그램 수(50%) + 프로그램 수혜 이용자 수(50%) |
| **21** | 도시공간 재생프로젝트 운영성과지수 | **D-3** | 100.0% | 도시공간 재생 프로젝트 건수(50%) + 프로젝트 참여 인원수(50%) |
| **22** | 문화 콘텐츠 개발프로젝트 운영성과지수 | **D-3** | 110.0% | 문화 콘텐츠 개발 프로젝트 건수(50%) + 프로젝트 참여 인원수(50%) |
| **23** | 글로벌 역량 강화지수 | **A-3** | 81.9% | 공동 연구(20%) + 공동 협력(30%) + 해외 교류 프로그램 참여자(50%) |
| **24** | 외국인 학생 유치 및 정착 지원 성과 지수 | **A-3** | 105.0% | 국제유학생 유치 수(60%) + 유학생 정착(20%) + 근로자 정착(20%) |

...
- **지원 규모**:
  ...
  - **2차년도 (2026년)**: 총 **91.83억원** (12개 단위과제 및 공통영역인 운영팀 공통운영경비 23.63억원 포함). 단, 신산업특화센터 이관 예산인 **A-1-나 (3.1억 원, 총 310백만원)**는 본사업비와 별도로 배정되어 총 운영 예산 규모는 **94.93억원**으로 통합 관리합니다.
...
- **조직 개편 반영 (6월 1일 자)**:
  - **신산업특화센터**가 신설되어 총 **3.1억 원(310백만원)의 사업 예산을 이관**받았으며, 이는 A-1-나(신산업특화 전문기술인재 양성)로 신규 과제화되어 전담 연구원에 의해 집행됩니다. (본사업비 91.83억 원과는 별도 예산으로 처리함)
...
3.  **전문 센터장 및 팀장교수 매핑**:
    ...
    *   **AID-X지원센터**: 센터장 김현수 교수 (총괄본부장 겸임)
        *   AI∙DX교육팀: 팀장 이정준 교수
    *   **울산늘봄누리센터**: 센터장 홍광표 교수
    *   **신산업특화센터**: A-1-나 신산업 이관 분 3.1억 원(310백만원) 총괄
...
| :--- | :---: | :--- |
| UC-HYPER 교수학습 모델 및 혁신 교수법 개발 운영 | 62.0 | 정자윤 |
| 미래 핵심 산업 맞춤형 정규 주문식 교과정 개편 및 운영 | 764.0 | 정자윤 |
| 특화 분야 비교과 자격증 과정 및 학점교류 운영 | 130.0 | 정자윤 |
| 전주기 이력 추적형 진로개발 시스템 운영 | 20.0 | 미지정 |
| 산학 성과 공유를 위한 경진대회 및 대외 워크숍 개최 | 26.0 | 정자윤 |
| 개방형 설계센터 전문가 연계 재직자 실무 교육 | 60.0 | 정자윤 |
| 전문기술석사 과정 활용 기업 PBL 공동연구 지원 | 94.0 | 서란 |
| 지산학 연계 개방형 설계센터(UDx-Lab) 구축 및 리모델링 | 385.0 | 정자윤 |
| AI·DX 기반 고성능 실습 PC 및 로봇 공학 기자재 도입 | 546.0 | 정자윤 |
| 지산학 거버넌스 협의체 운영 및 장학금 지원 | 263.0 | 정자윤 |

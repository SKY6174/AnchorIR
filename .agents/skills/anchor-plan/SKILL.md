...
1.  **IR 대시보드**: 전체 사업비의 연도별 요약, 본사업비/이월사업비 집행률, 재원 배분율 및 누적 집행 현황 그래프 등을 시각화하여 대외 보고를 지원합니다.
    ...
    *   **차트 시각화 및 UX 규격**:
        ...
        2.  *막대 그래프 (프로젝트별 재원/집행 현황)*:
            ...
            *   *X축/Y축 라벨 및 범례 (X/YAxis & Legend)*: X/Y축 정보의 크기는 기존에서 2pt 가량 키워 **`12px`**로 구성하며, 상단 범례 영역은 반투명 카드 형태(`background: "rgba(255, 255, 255, 0.03)"`, 테두리 처리)로 감싸서 범례 영역을 또렷하게 설정하고 글씨는 밝은 흰색 스팬으로 가독성을 확보합니다.

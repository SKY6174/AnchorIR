...
* **정의**: 최상위 추진전략을 달성하기 위한 구체적인 중점 과제 및 추진 분야입니다. 대시보드 내에서는 선택된 추진전략에 연계하여 `S1와 연계한 추진과제 (Strategic Tasks)` 와 같은 형식으로 연쇄 렌더링을 정의합니다.
...
* **5단계 기획 위계 체계**:
  ...
  - **단위과제 (Workstream; WS)** : 프로젝트 목표 달성을 위한 12대 단위과제 (A1가 ~ D3)

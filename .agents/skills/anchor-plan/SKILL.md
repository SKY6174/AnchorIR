...
1.  **PDCA 단계별 표준 프로세스 및 검증**:
    *   **P (Plan) 단계**:
        ...
        *   *월별 추진 일정 (PDCA) 레이아웃*: 12개월의 계획 선택 드롭다운 라인은 **가로 12개월 일렬**로 배치하며, 그 바로 아래에 실제 진행 현황을 대칭 비교해 볼 수 있는 **실제 실적(Actual) 12개월 라인**이 동일하게 종적 정렬(상: 계획 / 하: 실적) 노출되는 2줄 대칭 배치 구조를 취합니다.
